...
public class DatabaseService : IDatabaseService
{
    ...
    /// </summary>
     [KernelFunction]
     [Description("Get bookings by the hotel and minimum stay date.")]
    public async Task<IEnumerable<Booking>> GetBookingsByHotelAndMinimumDate([Description("The ID of the hotel")] int hotelId, [Description("minimum stay begin date")] DateTime dt)
    {
    ...
    [KernelFunction]
    [Description("Get bookings that are missing hotel room.")]
    ...
    [KernelFunction]
    [Description("Get bookings with multiple hotel room.")]
