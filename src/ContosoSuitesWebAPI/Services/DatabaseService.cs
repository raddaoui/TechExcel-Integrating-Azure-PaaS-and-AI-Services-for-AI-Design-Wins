...
public class DatabaseService : IDatabaseService
{
    ...
    public async Task<IEnumerable<Booking>> GetBookingsByHotelAndMinimumDate( [Description("The ID of the hotel")] int hotelId, [Description("specified data to get all bookings after")] DateTime dt)
    {
        ...
        public async Task<IEnumerable<Booking>> GetBookingsMissingHotelRooms()
    {
        ...
        [KernelFunction]
        [Description("Get all all bookings with more than one hotel room")]
